...
% TODO(Tarea 5/M6): tab:closest, tab:slowest, tab:largeslowclose below still
% carry values from the pre-B1 frozen catalogue (row 1 of tab:closest matches the
% b1fix regen at 1094 km; rows 2-5 differ). Regenerate from
% encounters_characterized_b1fix.parquet AND attach a per-row / per-stratum
% sigma(d_min) from the input-element covariance (tribunal B4), plus a
% boundary_minimum flag (M6), before submission.
